	...
	<main class="d-flex align-items-center justify-content-center flex-column">
		...
		<div class="container col-md-4 col-sm-8 p-3">
			<b-form @submit="onSubmit" class="element w-75 m-auto text-center">
				...
				<b-form-input id="username" class="my-2 text-center x-rounded" placeholder="Username"
					v-model="username"></b-form-input>

				<b-form-input id="email" class="my-2 text-center x-rounded" placeholder="Email" v-model="email"
					type="email"></b-form-input>
				<b-form-input id="emailConfirm" class="my-2 text-center x-rounded" placeholder="Confirm Email"
					v-model="emailConfirm" type="email"></b-form-input>

				<b-form-input id="password" v-model="password" class="my-2 text-center x-rounded" placeholder="Password"
					type="password"></b-form-input>
				<b-form-input id="passwordConfirm" v-model="passwordConfirm" class="my-2 text-center x-rounded"
					placeholder="Confirm Password" type="password"></b-form-input>
				...
				<b-button type="submit" class="m-2 w-50 x-rounded" id="loginBtn">Register</b-button>
			</b-form>
		</div>
	</main>
</template>
